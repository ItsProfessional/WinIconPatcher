...
namespace utl
{
	...
	void GetOpenWindows(std::vector<std::wstring>& windows);

	bool FindProcessId(const std::wstring& processName, DWORD& processId);

	bool GetFilesInDirectory(const std::wstring& directory, const std::wstring& format, std::vector<std::wstring>& files);
